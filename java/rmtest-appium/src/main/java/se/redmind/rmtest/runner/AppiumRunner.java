package se.redmind.rmtest.runner;
...
import se.redmind.rmtest.config.AppiumGridConfiguration;
import se.redmind.rmtest.config.Configuration;
import se.redmind.rmtest.runners.FilterDrivers;
import se.redmind.rmtest.runners.Parallelizable;
...
public class AppiumRunner extends Parameterized implements Parallelizable {
    ...
    public AppiumRunner(Class<?> klass) throws Throwable {
        super(klass);
    ...
    public void run(RunNotifier notifier) {
        ...
        if (Configuration.current().drivers.stream().anyMatch(driver -> driver instanceof AppiumGridConfiguration && driver.as(AppiumGridConfiguration.class).enableLiveStream)) {
    ...
    protected TestClass createTestClass(Class<?> testClass) {
        ...
        return new TestClass(testClass) {
            ...
            private final TestClass runnerAsTestClass = new TestClass(AppiumRunner.this.getClass()) {
                @Override
                protected void scanAnnotatedMembers(Map<Class<? extends Annotation>, List<FrameworkMethod>> methodsForAnnotations,
                                                    Map<Class<? extends Annotation>, List<FrameworkField>> fieldsForAnnotations) {
                    try {
                        addToAnnotationLists(new FrameworkMethod(AppiumRunner.this.getClass().getMethod("getDriversAsParameters")) {
                            ...
                            public Object invokeExplosively(Object target, Object... params) throws Throwable {
                                ...
                                return super.invokeExplosively(AppiumRunner.this, params);
                            }
